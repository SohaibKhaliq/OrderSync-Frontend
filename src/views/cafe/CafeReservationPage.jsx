      ...
      <div className="w-full max-w-4xl px-6 md:px-12">
        <div className="text-center mb-12">
          ...
          <p className="text-neutral opacity-70 max-w-2xl mx-auto">
            Reserve your spot for an unforgettable culinary experience. Whether
            it's a romantic dinner or a gathering with friends, we've got the
              ...
              >
                ...
                {tables.map((t) => (
                  <option key={t.id} value={t.id}>
                    {t.title} - {t.floor} (Capacity: {t.seating_capacity})
                  </option>
                ))}
              </select>
            </div>
