...
const CartPage = () => {
  ...
  useEffect(() => {
    ...
    const { itemsTotal, taxTotal, payableTotal } =
  ...
  const sendNewOrderEvent = () => {
    // Emit new_order so admin OrdersPage / KitchenPage refresh automatically
    socket.emit("new_order", {}, qrcode);
  ...
  return (
    <div className="w-full">
      <div className="container w-full md:w-96 mx-auto flex justify-center items-center">
        <div className="w-full mx-auto md:w-96 bg-gray-50 rounded-xl p-4 h-screen">
          {" "}
            ...
            {cartItems.length > 0 ? (
              cartItems.map((item, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="w-full bg-white rounded-lg p-2 mb-2 flex items-center justify-between"
                  >
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <div className="flex items-center">
                        ...
                        <div className="text-center text-sm w-6">
                          {quantity}
                        </div>
        ...
        <dialog
          ...
          className="modal modal-bottom sm:modal-middle w-full mx-auto md:w-96"
        >
              ...
              <div className="flex flex-col justify-around mt-4">
                <button
                  className={`rounded-lg transition px-4 py-3 text-lg font-semibold  border-2 ${
                    !showPhoneFields
                      ? "bg-white border-restro-green text-restro-green shadow-sm"
