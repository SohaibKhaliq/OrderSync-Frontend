...
function generateSeedOrders() {
  ...
  // Attach order_items inline (stored separately but generated together for seeding)
  const orderItems = {
    1: [
      {
        id: 1,
        order_id: 1,
        menu_item_id: 11,
        menu_item_title: "Chicken Karahi",
        quantity: 1,
        unit_price: 550,
        total_price: 550,
        variant: "Half",
      ...
      },
      {
        ...
        order_id: 1,
        menu_item_id: 1,
        menu_item_title: "Doodh Patti Chai",
        quantity: 3,
        unit_price: 80,
        total_price: 240,
        variant: null,
    ...
    6: [
      {
        ...
        order_id: 6,
        menu_item_id: 22,
        menu_item_title: "Seekh Kebab Roll",
        quantity: 2,
        unit_price: 310,
        total_price: 620,
        variant: null,
    ...
    10: [
      ...
      },
      {
        ...
        order_id: 10,
        menu_item_id: 5,
        menu_item_title: "Rooh Afza Sharbat",
        quantity: 1,
        unit_price: 70,
        total_price: 70,
        variant: null,
    ...
    12: [
      {
        ...
        order_id: 12,
        menu_item_id: 15,
        menu_item_title: "Halwa Puri (2 pcs)",
        quantity: 2,
        unit_price: 250,
        total_price: 500,
        variant: null,
    ...
    15: [
      ...
      },
      {
        ...
        order_id: 15,
        menu_item_id: 24,
        menu_item_title: "Gulab Jamun (2 pcs)",
        quantity: 2,
        unit_price: 100,
        total_price: 200,
        variant: null,
...
// ── Seed: customer portal (OCOS) accounts ────────────────────────────────
  ...
  return [
    {
      ...
      payment_type: "jazzcash",
      payment_status: "paid",
      special_instructions: "More raita please",
      created_at: ago(0, 12),
      updated_at: ago(0, 13),
    },
    {
    ...
    },
    {
      ...
      payment_type: "card",
      payment_status: "paid",
      special_instructions: "Extra paya",
      created_at: ago(1, 19),
      updated_at: ago(1, 20),
    },
    {
    ...
    },
    {
      ...
      payment_type: "cash",
      payment_status: "paid",
      special_instructions: "Extra chana",
      created_at: ago(2, 9),
      updated_at: ago(2, 10),
    },
    {
      ...
      payment_type: "easypaisa",
      payment_status: "paid",
      special_instructions: "Extra sauce in rolls",
      created_at: ago(3, 14),
      updated_at: ago(3, 15),
    },
    {
      ...
      payment_type: "card",
      payment_status: "paid",
      special_instructions: "Sweet-tooth order!",
      created_at: ago(3, 15),
      updated_at: ago(3, 16),
    },
    {
      ...
      payment_type: "jazzcash",
      payment_status: "paid",
      special_instructions: "FAST-NU gate delivery",
      created_at: ago(5, 12),
      updated_at: ago(5, 13),
    },
    {
      ...
      payment_type: "cash",
      payment_status: "paid",
      special_instructions: "Extra butter",
      created_at: ago(6, 9),
      updated_at: ago(6, 10),
    },
    {
      ...
      payment_type: "easypaisa",
      payment_status: "paid",
      special_instructions: "Snack box for hostel",
      created_at: ago(7, 16),
      updated_at: ago(7, 17),
    },
    {
      ...
      payment_type: "card",
      payment_status: "paid",
      special_instructions: "CS dept group order \u2013 FAST-NU",
      created_at: ago(9, 13),
      updated_at: ago(9, 14),
    },
    {
      ...
      payment_type: "jazzcash",
      payment_status: "paid",
      special_instructions: "LUMS library study session order",
    ...
    },
    {
      ...
      special_instructions: "Full karahi ×2 \u2013 cancelled by customer",
    ...
    },
    {
      ...
      payment_type: "easypaisa",
      payment_status: "paid",
      special_instructions: "Girls hostel wing C",
    ...
    },
    {
      ...
      payment_type: "jazzcash",
      payment_status: "paid",
      special_instructions: "Morning delivery before 9 AM",
      created_at: ago(16, 8),
      updated_at: ago(16, 9),
    },
    {
      ...
      payment_type: "cash",
      payment_status: "paid",
      special_instructions: "Mithai for housemates",
    ...
    },
    {
      ...
      payment_type: "card",
      payment_status: "paid",
      special_instructions: "Late night study session order",
...
export function initDB() {
  ...
  if (!localStorage.getItem(DB_KEY) || storedVersion !== SEED_VERSION) {
    ...
    // Flatten order_items out of each order._items into db.order_items
    db.order_items = db.orders.flatMap((o) => o._items || []);
    db.orders = db.orders.map(({ _items, ...rest }) => rest);
    saveDB(db);
